<?php
    $faq_section_h2 = get_option('poh_di_lpp_faq_section_h2');
    $faq_section_title_list = get_option('poh_di_lpp_faq_section_title_list');
    $faq_section_description_list = get_option('poh_di_lpp_faq_section_description_list');
?>
<!-- Begin FAQ template part -->
<section id="poh-di-lpp-faq-section" class="section-padding">
    <div>
