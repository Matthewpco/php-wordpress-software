<?php
$footer_image_url = get_option('poh_di_b_lpp_footer_image_url');
$footer_phone_number = get_option('poh_di_b_lpp_footer_phone_number');
$footer_phone_number_text = get_option('poh_di_b_lpp_footer_phone_number_text');
$footer_small_text = get_option('poh_di_b_lpp_footer_small_text');
$footer_facebook_url = get_option('poh_di_b_lpp_footer_facebook_url');
$footer_instagram_url = get_option('poh_di_b_lpp_footer_instagram_url');
$footer_youtube_url = get_option('poh_di_b_lpp_footer_youtube_url');
$footer_privacy_policy_text = get_option('poh_di_b_lpp_footer_privacy_policy_text');
$footer_privacy_policy_url = get_option('poh_di_b_lpp_footer_privacy_policy_url');
?>

<!-- Begin footer section -->
    <footer id="poh-di-b-lpp-footer-section">
